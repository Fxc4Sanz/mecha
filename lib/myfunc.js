...
exports.serialize = (surya, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === surya.user.jid ? true : false
    ...
    const conts = msg.key.fromMe ? surya.user.jid : surya.contacts[msg.sender]
	msg.pushname = msg.key.fromMe ? surya.user.name : !conts ? '-' : conts.notify || conts.vname || conts.name || '-'   
