...
const jadibot = async(reply,surya,id,rya) => {
...
bot = await surya.sendMessage(id,buffer,MessageType.image,{quoted : rya,caption:'Scan QR Untuk menjadi BOT Sementara!\n\n1.Klik titik tiga pojok kanan atas\n2.Ketuk Whatsapp Web\n3.Scan QR ini\n\nNote : QR Expired dalam 20detik!'})
setTimeout(() => {
surya.deleteMessage(id, bot.key)
},30000)
})
conn.on('connecting', () => {
})
